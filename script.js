...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const certificates = [
        ...
        { title: "Ecology: Ecosystem Dynamics and Conservation (American Museum of Natural History, Oct 2024)", img: "images/Ecology-Ecosystem-Conservation.jpg", category: ["ehs", "systems"], skills: "Conservation, Ecosystem Ecology, Environmental Management" },
        ...
        { title: "Greening the Economy: Sustainable Cities (Coursera, May 2019)", img: "images/Greening the Economy.jpg", category: ["foresight", "ehs", "systems"], skills: "Foresight, EHS, Futures Thinking, Systems Thinking, Urban Sustainability" },
        ...
        { title: "Managerial Accounting: Cost Behaviors, Systems and Analysis (Coursera, Aug 2019)", img: "images/Managerial Accounting, Cost Behaviours, Systems and Analysis.jpg", category: ["foresight"], skills: "Futures Thinking, Cost Analysis, Financial Management, Systems Thinking" },
        ...
        { title: "Planning for Climate Change in African Cities (Coursera, Apr 2022)", img: "images/Planning for Climate Change.jpg", category: ["foresight", "ehs", "systems"], skills: "Foresight, EHS, Futures Thinking, Systems Thinking, Urban Planning" },
